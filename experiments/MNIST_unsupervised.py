...
lins = [gen_lin(100, 4 * 2**-i, "lin100_{}".format(i)) for i in range(2)]
...
pts = [gen_pt(100, 64 * 2**-i, "pt100_{}".format(i)) for i in range(2)]
pts_soft = [gen_pt(100, 64 * 2**-i, False, "pt_soft100_{}".format(i)) for i in range(2)]
